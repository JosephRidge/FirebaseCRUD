...
interface TaskService {
    ...
    suspend fun addTask(task: Task, localImagePaths: List<String>, readBytes: (String?) -> ByteArray): Task                // Create
    suspend fun updateTask(task: Task, localImagePaths: List<String>, readBytes: (String?) -> ByteArray) :Task            // Update
